...
const Home = () => {
  ...
  useEffect(() => {
    async function fetchMyList() {
      await Moralis.start({
        serverUrl: "https://ffoeks8zega3.usemoralis.com:2053/server",
        appId: "VI9EknEJ5mZTRX2Cxd2gQNYyHdTubJTXBfRnzEYa",
            ...
            >
              <div className="modalContent">
                ...
                <div className="modalPlayButton">
                  {isAuthenticated ? (
                    <>
                      <Link style={{ textDecoration: 'none' }} to="/player" state={selectedFilm.Movie}>
                        <Button
                          icon="chevronRightX2"
                          text="Play"
                          theme="secondary"
